...
MAKEFILE = getUnitvectorsFromTensions14_mex.mk

include getUnitvectorsFromTensions14_mex.mki
...
MEX_FILE_NAME_WO_EXT = getUnitvectorsFromTensions14_mex
...
SYS_INCLUDE += -I "/home/kotaru/workspace/git/HybridRobotics/mutliple-quadrotor-flexible-hose/matlab/utils/func_generators/codegen/mex/getUnitvectorsFromTensions14"
...
%.$(OBJEXT) : /home/kotaru/workspace/git/HybridRobotics/mutliple-quadrotor-flexible-hose/matlab/utils/func_generators/codegen/mex/getUnitvectorsFromTensions14/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/kotaru/workspace/git/HybridRobotics/mutliple-quadrotor-flexible-hose/matlab/utils/func_generators/codegen/mex/getUnitvectorsFromTensions14/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/kotaru/workspace/git/HybridRobotics/mutliple-quadrotor-flexible-hose/matlab/utils/func_generators/codegen/mex/getUnitvectorsFromTensions14/%.cu
	$(CC) $(CCFLAGS) "$<"
