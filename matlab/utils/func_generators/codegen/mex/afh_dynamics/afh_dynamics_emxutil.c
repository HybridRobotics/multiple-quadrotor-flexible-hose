...
{
  pStruct->mge3.size[0] = 0;
  pStruct->mge3.size[1] = 0;
  pStruct->b_I.size[0] = 0;
  pStruct->l.size[0] = 0;
  pStruct->Mtop.size[0] = 0;
  pStruct->Mtop.size[1] = 0;
  pStruct->mbar.size[0] = 0;
  pStruct->J.size[0] = 0;
  pStruct->J.size[1] = 0;
  pStruct->J.size[2] = 0;
  pStruct->Jinv.size[0] = 0;
  pStruct->Jinv.size[1] = 0;
  pStruct->Jinv.size[2] = 0;
  emxInit_real_T(sp, &pStruct->M, 2, srcLocation, doPush);
}
...
/* End of code generation (afh_dynamics_emxutil.c) */
