...
params.computeRecattiGains = false;
...
% initial condition
% -----------------
INIT_COND = 'flatness'; % {'close', 'flatness', 'perturb-cable'}
...
opts.figure.x.limits = [-5 5];
opts.figure.y.limits = [-5 5];
opts.figure.z.limits = [-5 5];
